...
class Config:
    def __init__(self) -> None:
        self.API_ID: str = os.environ.get("35297209", None)
        self.API_HASH: str = os.environ.get("06e705c80aac7add5524f4a1cf4324a3", None)
        self.SESSION: str = os.environ.get("SESSION", None)
        self.BOT_TOKEN: str = os.environ.get("8740721397:AAEEIDXMD4I8K27uDcl9qndmI9Syab1GcaI", None)
        self.SUDOERS: list = [
